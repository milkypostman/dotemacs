...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("7ddate" "" (lambda nil (insert (format-time-string "%Y-%m-%d" (time-add (current-time) (seconds-to-time (* 7 86400)))))) 4)
    ("7dfull" "" (lambda nil (insert (format-time-string "%A, %B %d, %Y" (time-add (current-time) (seconds-to-time (* 7 86400)))))) 4)
